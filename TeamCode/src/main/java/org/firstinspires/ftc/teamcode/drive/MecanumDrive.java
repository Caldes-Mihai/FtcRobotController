...
public class MecanumDrive extends RobotDrive {
     ...
     */
    public MecanumDrive(CacheableMotor frontLeft, CacheableMotor frontRight, CacheableMotor backLeft, CacheableMotor backRight) {
     ...
     * @param backRight  the back right motor
     */
    public MecanumDrive(boolean autoInvert, CacheableMotor frontLeft, CacheableMotor frontRight, CacheableMotor backLeft, CacheableMotor backRight) {
        motors = new CacheableMotor[]{frontLeft, frontRight, backLeft, backRight};
     ...
     */
    public void driveWithCacheableMotorPowers(double frontLeftSpeed, double frontRightSpeed,
